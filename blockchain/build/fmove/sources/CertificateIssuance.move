module certi::CertificateIssuance {
    ...
    certificatesIssuances : table::Table<String, CertificateIssuance>,
      ...
      struct CertificateIssuance has key,store,copy{
        issuer: address,
    ...
    #[view]
    public fun get_certificate_issuance(issuer_address : address,issuanceId : String): CertificateIssuance acquires CertificatesIssuancesStore {
