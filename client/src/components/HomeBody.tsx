      ...
      <div className="flex flex-col justify-center items-start w-1/2 p-6 space-y-4 ml-24 ">
        <div className="flex items-center space-x-4 mb-6 ">
          ...
          <div className="flex flex-col">
            <h1 className="text-4xl font-bold text-gray-800 animate-color-change">CertiChain</h1>
        ...
        <div className="flex justify-center ">
          <Button className="bg-black text-white hover:bg-blue-600 px-16 py-2 rounded-2xl">
            Read more about us
          </Button>
        </div>
      </div>
